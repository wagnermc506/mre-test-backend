    ...
    const moduleFixture: TestingModule = await Test.createTestingModule({
      ...
      providers: [
        ...
        NoticiaCacheService,
        {
          ...
          useValue: mockNoticiaRepository,
        },
      ],
    }).compile();
  ...
  describe('GET /noticias/:id', () => {
    describe('dado um id existente', () => {
      it('então deve retornar a noticia com status 200', async () => {
        ...
        expect(mockNoticiaRepository.findOneBy).toHaveBeenCalledWith({
          id: 'id-1',
        });
      });
    });
  ...
  describe('DELETE /noticias/:id', () => {
    describe('dado um id existente', () => {
      it('então deve remover a noticia com status 200', async () => {
        ...
        await request(app.getHttpServer()).delete('/noticias/id-1').expect(200);

        expect(mockNoticiaRepository.remove).toHaveBeenCalledWith(
          noticiaExistente,
        );
      });
    });
